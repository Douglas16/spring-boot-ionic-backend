...
public class Cliente implements Serializable {
	...
	public Cliente(Integer id, String nome, String email, String cpfOuCnpj, TipoCliente tipo) {
		...
		//nao pode ser nulo se tipo= nulo fica nulo caso contrario o codigo dele
...
//ARMAZENAR O TIPO INTEIRO INTERNAMENTE CONTROLADO PELO SISTEMA CRIADO
	//EXPOE PARA O CLIENTE O TIPO
